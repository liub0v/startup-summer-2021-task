...
export const Profile = React.memo((props) => {
        ...
        return (
            <>
                <img alt="avatar" className="user-avatar" src={profileData.avatar_url}/>
                <div>
                    <div className="user-name">
                        <label>{profileData.name}</label>
                    </div>
                    <div className="user-login">
                        <a rel="noreferrer" target="_blank" href={profileData.html_url}> {profileData.login}</a>
                    </div>
                </div>
                <div className="container-following-info">
                    <div>
                        ...
                        <label>{parseNumber(profileData.followers)} followers</label>
                    </div>
                    <div>
                        ...
                        <label>{parseNumber(profileData.following)} following</label>
                    </div>
                </div>
            </>
